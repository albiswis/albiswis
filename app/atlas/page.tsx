...
export const metadata = {
  title: "Atlas | AlbisWis",
  description:
    "Atlas is an AI platform for property operations and portfolio intelligence — automating property management, leasing, reporting, maintenance, and portfolio analytics for real estate companies.",
};
...
const outcomes = [
  {
    h: "Better portfolio visibility",
    p: "Bring every property, project, and contract into one view — up to date, every day.",
  },
  {
    h: "Reduced operational overhead",
    p: "Automate the workflows your teams used to chase across emails, spreadsheets, and systems.",
  },
  {
    h: "Faster reporting",
    p: "Generate investor, lender, and internal reports in hours instead of weeks.",
  },
  {
    h: "Improved asset performance",
    p: "Spot underperforming assets and intervention opportunities before the next quarter closes.",
  },
];
    ...
    <>
      <section className="slab slab-dark">
        <div className="container-x page-top grid min-h-[80vh] items-end gap-12 pb-20 md:grid-cols-2 md:pb-32">
          <div>
            <div className="earmark text-text-muted">Atlas</div>
            <h1
            ...
            <p className="mt-8 max-w-xl text-[20px] text-text-soft/80">
              AI for property operations & portfolio intelligence — Atlas helps
              real estate companies automate property management workflows,
              reporting, leasing operations, maintenance coordination, and
              portfolio analytics.
            </p>
          ...
          <div className="relative aspect-[4/3] w-full overflow-hidden border border-white/15">
            <Image
              ...
              alt="Atlas — AI for real estate operations"
              fill
      ...
      <section className="slab slab-light">
        <div className="container-x grid gap-8 py-20 md:grid-cols-[1fr,2fr] md:gap-16 md:py-28">
          ...
          <p className="font-display text-[clamp(22px,3.5vw,50px)] font-normal leading-[1.2]">
            Connect properties, projects, tenants, financial systems, and
            operational data into one intelligent workspace — so every team
            decides from the same source of truth.
          </p>
        </div>
      </section>
      ...
      <section className="slab slab-dark">
        <div className="container-x py-20 md:py-28">
          ...
          >
            Where Atlas goes to work across your portfolio.
          </h2>
      ...
      <section className="slab slab-dark">
        <div className="container-x flex flex-col items-start justify-between gap-8 py-20 md:flex-row md:items-end md:py-24">
          <h3 className="font-display text-[clamp(28px,5vw,60px)] font-normal leading-[1.05] text-white">
            See Atlas across your portfolio.
          </h3>
