...
export const metadata = {
  title: "Voya | AlbisWis",
  description:
    "Voya is an AI-powered logistics and supply chain intelligence platform — connecting transportation, warehouses, inventory, suppliers, and procurement into one unified operating system.",
};
...
const outcomes = [
  {
    h: "Reduced logistics costs",
    p: "Cut transportation, warehousing, and expediting spend by routing decisions through one model of the network.",
  },
  {
    h: "Improved inventory accuracy",
    p: "Keep stock levels in lock-step with demand so you carry less and stock out less.",
  },
  {
    h: "Faster order fulfillment",
    p: "Compress order-to-delivery cycle times by automating the handoffs between systems and teams.",
  },
  {
    h: "Better supply chain visibility",
    p: "See every shipment, supplier, and SKU on one map — across modes, regions, and partners.",
  },
  {
    h: "Reduced supply chain disruptions",
    p: "Spot risks early and reroute around them — weather, supplier outages, capacity crunches.",
  },
];

export default function Voya() {
  return (
    <>
      <section className="slab slab-dark">
        <div className="container-x page-top grid min-h-[80vh] items-end gap-12 pb-20 md:grid-cols-2 md:pb-32">
          <div>
            <div className="earmark text-text-muted">Voya</div>
            <h1
            ...
            <p className="mt-8 max-w-xl text-[20px] text-text-soft/80">
              AI-Powered Logistics, Inventory & Supply Chain Operations — Voya
              helps logistics and supply chain organizations connect
              transportation systems, warehouses, inventory data, suppliers,
              procurement workflows, and enterprise applications into a
          ...
          <div className="relative aspect-[4/3] w-full overflow-hidden border border-white/15">
            <Image
              ...
              alt="Voya — AI for logistics and supply chain"
              fill
      ...
      <section className="slab slab-light">
        <div className="container-x grid gap-8 py-20 md:grid-cols-[1fr,2fr] md:gap-16 md:py-28">
          ...
          <p className="font-display text-[clamp(22px,3.5vw,50px)] font-normal leading-[1.2]">
            Gain real-time visibility across the supply chain, automate
            operational workflows, optimize inventory levels, improve delivery
            performance, and make faster decisions through a single
            intelligence platform — built for route optimization, inventory
            planning, predictive maintenance, demand forecasting, and logistics
            automation.
          </p>
        </div>
      </section>
      ...
      <section className="slab slab-dark">
        <div className="container-x py-20 md:py-28">
          ...
          >
            Where Voya goes to work across your network.
          </h2>
      ...
      <section className="slab slab-dark">
        <div className="container-x flex flex-col items-start justify-between gap-8 py-20 md:flex-row md:items-end md:py-24">
          <h3 className="font-display text-[clamp(28px,5vw,60px)] font-normal leading-[1.05] text-white">
            See Voya across your supply chain.
          </h3>
